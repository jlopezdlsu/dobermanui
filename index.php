      ...
      <div data-slider-id="1" class="owl-carousel hero-1-slider owl-loaded owl-drag">
        <div class="owl-stage-outer">
          <div class="owl-stage" style="transform: translate3d(-2220px, 0px, 0px); transition: all 0.25s ease 0s; width: 7770px;">
            ...
            </div></div><div class="owl-item cloned" style="width: 1110px;"><div class="item">
              <div class="row d-flex flex-row align-items-center">
                <div class="col-md-6 text">
                  <h5>Professional Edition</h5>
                  <h1>Premium Quality</h1>
            ...
            </div></div><div class="owl-item active" style="width: 1110px;"><div class="item">
              <div class="row d-flex flex-row align-items-center">
                <div class="col-md-6 text">
                ...
                <div class="col-md-6 product"><img src="https://d19m59y37dris4.cloudfront.net/photo/1-4-1/img/hero-3.png" alt="lens" class="img-fluid d-none d-md-block"></div>
              </div>
